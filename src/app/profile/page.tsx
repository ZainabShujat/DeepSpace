  ...
  useEffect(() => {
    const loadProfile = async () => {
      ...
      if (sessionUser) {
        ...
        setProfile({
          username: row?.username || sessionUser.email || "Member",
          avatar: row?.avatar || "/avatars/strawberry.png",
          mode: "logged-in",
      ...
      setProfile({
        ...
        avatar: localStorage.getItem("avatar") || "/avatars/strawberry.png",
        mode: "guest",
      });
    };
      ...
      <div className="mx-auto max-w-4xl rounded-[36px] border border-black/10 bg-white p-8 shadow-[0_24px_80px_rgba(0,0,0,0.08)]">
        <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-5xl font-black">{profile.username}</h1>
          ...
          <div className="flex items-center gap-4 rounded-[28px] border border-black/10 bg-[#f4f4f5] px-5 py-4">
            ...
            <img src={profile.avatar} alt={profile.username} className="h-20 w-20 rounded-full border border-black/10 object-cover" />
            <div>
