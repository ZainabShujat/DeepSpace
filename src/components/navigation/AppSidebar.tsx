    ...
    <>
      {!open && (
        <button
          ...
          className="fixed left-5 top-5 z-70 rounded-md border-2 border-black bg-white/95 p-2 shadow-[4px_4px_0_#000] transition hover:-translate-y-px md:left-6 md:top-6"
        >
      ...
      {open && (
        <div className="fixed inset-0 z-40">
          ...
          <aside className="absolute left-0 top-0 bottom-0 z-80 flex w-80 max-w-[88vw] flex-col gap-6 border-r border-black bg-[#111111] px-5 py-6 text-white shadow-[8px_0_0_#000]">
